  ...
  function renderIdrgMapSlide() {
    ...
    const filteredCases = (row) => {
      ...
      return row.segments.reduce((sum, segment) => {
        ...
        if (ui.hospitalClass === "WITHOUT_SPECIAL" && hospitalClass === "RS KHUSUS") return sum;
        if (["A", "B", "C", "D", "RS KHUSUS"].includes(ui.hospitalClass) && hospitalClass !== ui.hospitalClass) return sum;
