                    ...
                    ${idx === 0 ? `
                      <td rowspan="${window.competencySimScenarios.length}" style="border: 1px solid #1e293b; padding: 8px; background: #f8fafc;">
                        <div style="font-size:12px;line-height:1.55;text-align:left;min-width:155px;">
                          ...
                          ${severityRanks.map((level) => `<div style="font-weight:${servedExistingLevels.includes(level) ? '900' : '400'};color:${servedExistingLevels.includes(level) ? '#0f172a' : '#64748b'};">${shortLevelNames[level]}: ${formatNumber(existingLevelValues[level])}</div>`).join('')}
    ...
    return `<div class="per-service-source-bar" style="margin:2px 0 5px;padding:7px 8px;background:#f5f3ff;border:1px solid #ddd6fe;border-radius:6px;font-size:10px;color:#5b21b6;font-weight:750;display:flex;align-items:center;justify-content:space-between;gap:10px;flex-wrap:wrap;">
      ...
      <div style="overflow-x:auto;width:100%;"><table style="width:100%;border-collapse:collapse;border:1px solid #1e293b;text-align:center;font-size:10px;">
        <thead><tr>
          ...
          <th rowspan="2" style="border:1px solid #fff;padding:5px;background:#0369a1;color:#fff;">TOTAL KASUS PASCA RBKP</th>
          ...
          <th style="background:#10b981;color:#fff;padding:4px;">% Dinamis <button onclick="copyColData(this, 'srv-tb-pct')" style="background:none;border:none;cursor:pointer;padding:0;font-size:10px;" title="Copy Kolom">??</button></th><th style="background:#10b981;color:#fff;padding:4px;">Kasus <button onclick="copyColData(this, 'srv-tb-kasus')" style="background:none;border:none;cursor:pointer;padding:0;font-size:10px;" title="Copy Kolom">??</button></th><th style="background:#10b981;color:#fff;padding:4px;">Pendapatan <button onclick="copyColData(this, 'srv-tb-rp')" style="background:none;border:none;cursor:pointer;padding:0;font-size:10px;" title="Copy Kolom">??</button></th>
          <th style="background:#f43f5e;color:#fff;padding:4px;">% Dinamis <button onclick="copyColData(this, 'srv-kr-pct')" style="background:none;border:none;cursor:pointer;padding:0;font-size:10px;" title="Copy Kolom">??</button></th><th style="background:#f43f5e;color:#fff;padding:4px;">Kasus <button onclick="copyColData(this, 'srv-kr-kasus')" style="background:none;border:none;cursor:pointer;padding:0;font-size:10px;" title="Copy Kolom">??</button></th><th style="background:#f43f5e;color:#fff;padding:4px;">Pendapatan <button onclick="copyColData(this, 'srv-kr-rp')" style="background:none;border:none;cursor:pointer;padding:0;font-size:10px;" title="Copy Kolom">??</button></th>
          <th style="background:#14b8a6;color:#fff;padding:4px;">Kasus <button onclick="copyColData(this, 'srv-nt-kasus')" style="background:none;border:none;cursor:pointer;padding:0;font-size:10px;" title="Copy Kolom">??</button></th><th style="background:#14b8a6;color:#fff;padding:4px;">% Kasus <button onclick="copyColData(this, 'srv-nt-kasuspct')" style="background:none;border:none;cursor:pointer;padding:0;font-size:10px;" title="Copy Kolom">??</button></th><th style="background:#14b8a6;color:#fff;padding:4px;">Pendapatan <button onclick="copyColData(this, 'srv-nt-rp')" style="background:none;border:none;cursor:pointer;padding:0;font-size:10px;" title="Copy Kolom">??</button></th><th style="background:#14b8a6;color:#fff;padding:4px;">% Pendapatan <button onclick="copyColData(this, 'srv-nt-rppct')" style="background:none;border:none;cursor:pointer;padding:0;font-size:10px;" title="Copy Kolom">??</button></th>
