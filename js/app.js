  ...
  function renderDynamicMarketShareSlide() {
    ...
    container.innerHTML = `
      ...
      <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:8px;margin-bottom:9px;">
        ...
        <div style="padding:8px 10px;border:1px solid #e2e8f0;border-radius:8px;background:#f8fafc;"><div style="font-size:10px;color:#64748b;font-weight:800;">iDRG EKSISTING</div><strong style="font-size:18px;color:#0369a1;">${formatTableMoney(baselineIdrg)}</strong><div style="margin-top:2px;font-size:9px;font-weight:850;color:${baselineIdrg - baselineIna >= 0 ? "#047857" : "#be123c"};">Selisih ${baselineIdrg - baselineIna >= 0 ? "+" : ""}${formatTableMoney(baselineIdrg - baselineIna)} · ${baselineIdrg - baselineIna >= 0 ? "+" : ""}${(baselineIna > 0 ? (baselineIdrg - baselineIna) / baselineIna * 100 : 0).toFixed(2).replace(".", ",")}%</div></div>
