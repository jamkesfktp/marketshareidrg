...
(function () {
  ...
  function money(n) {
    ...
    var formatted;
    if (abs >= 1e9) {
        formatted = inMilyar.toLocaleString("id-ID", { minimumFractionDigits: 2, maximumFractionDigits: 2 });
    } else {
        formatted = inMilyar.toLocaleString("id-ID", { minimumFractionDigits: 3, maximumFractionDigits: 3 });
    }
